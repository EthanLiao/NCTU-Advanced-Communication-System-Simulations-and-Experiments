...
SNR = 10
% Second_moment_noise = mean(Gray_dataIn_recieve.^2)*(10^(-SNR/10))
% noise = Second_moment_noise*randn(1,length(Gray_dataIn_recieve))
% Gray_signal_recieve = Gray_dataIn_recieve+3.*noise
