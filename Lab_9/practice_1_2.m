...
% modulatoin part
t_DMA_filtered_signal = filter(IIR_filter,DAC(signal,DMA_sampling_factor))
...
subplot(2,1,2);stem(r_Digital_filtered_signal./max(abs(r_Digital_filtered_signal)));title('Recieved Signal');grid on;
